...
ATP_ThirdPersonCharacter::ATP_ThirdPersonCharacter()
{
	...
	FollowCamera->SetupAttachment(GetMesh(),FName("head")); // Attach the camera to the end of the boom and let the boom adjust to match the controller orientation
...
void ATP_ThirdPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Throw", IE_Pressed, this, &ATP_ThirdPersonCharacter::StartThrow);
	PlayerInputComponent->BindAction("Throw", IE_Released, this, &ATP_ThirdPersonCharacter::StopThrow);
